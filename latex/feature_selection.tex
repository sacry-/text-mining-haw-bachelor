...
\label{sec:semantic_selection}
  ...
  In the following we give an example to understand the notion of a lexical closure. Given a document with one sentence, \emph{the dog and the cat}. The transformation of this sentence stripped by stopwords results in
