...
\label{sec:basics_intro}
  ...
  The text summarization and clustering task is closely related. How can clustering be used to improve and create textual summaries over documents or single articles? The following 
