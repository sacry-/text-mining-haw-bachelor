...
from ner_tagger import get_configured_ner_tagger
...
def prep_from_chunk(chunk, tokenizer=None):
...
if __name__ == "__main__":
  ...
  class Chunk():
    ...
    def __init__(self, text):
      self.index = "20150704"
      self.id = "mina_liccione_title"
      self.title = "Mina Liccione Title"
      self.text = text
      self.article_html = text
