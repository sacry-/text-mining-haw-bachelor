...
BASE = "/Users/sacry/dev/uni/bachelor/dependencies/stanford-ner"
NER_JAR_PATH = "%s/stanford-ner.jar" % BASE
CLASSIFIER_PATH = "%s/classifiers/english.muc.7class.distsim.crf.ser.gz" % BASE

STANFORD_NER = NERTagger( CLASSIFIER_PATH, NER_JAR_PATH ) 
...
class NerTagger():
  ...
  def tag(self):
    self.tagged = STANFORD_NER.tag( self.tokens )
    return self.tagged
